...
/*
*
* Simple scene with one point light and multiple spheres with different specular properties
* Point lights (Also called Omni lights) are useful for simulating pulbs or any sources that send light in all directions
*
*/

void PointLightScene::Initialize() {
    shader = new Shader();
...
void PointLightScene::Update(double delta_time) {
